...
class Home extends React.Component {
  render() {
    return (
      <div className="home">
        <div className="top" onClick={()=>alert("home")}>
          <h1>Minimalist Men Shop</h1>
          <Card className="cardOpen">
            <Card.Img src="https://images.unsplash.com/photo-1622445272461-c6580cab8755?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8YmxhbmslMjB0c2hpcnR8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=60" alt="Card image" style={{height:"80vh", width:"80%"}} />
            <Card.ImgOverlay>
              <div className="cardOpenProp">
              <Card.Text>be polos be yourself</Card.Text>
              </div>
              <div className="cover"><i className="fas fa-magnifying-glass"></i></div>
        ...
        <div className="jacket">
          ...
          <Image
            src="https://images.unsplash.com/photo-1519764622345-23439dd774f7?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8bWluaW1hbGlzdCUyMGJsYWNrJTIwamFja2V0fGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=60"
            rounded
            className="jacket-prod"
          />
        </div>
